...
```
Link: <http://api.nz.sandbox.zepto.money/contacts?page=5>; rel="last", <http://api.nz.sandbox.zepto.money/contacts?page=2>; rel="next"
Per-Page: 25
Total: 5
```
...
```shell
curl --request POST \
  --url https://api.nz.sandbox.zepto.money/open_agreements \
  --header 'accept: application/json' \
  --header 'authorization: Bearer {access-token}' \
  --header 'content-type: application/json' \
...
url = URI("https://api.nz.sandbox.zepto.money/open_agreements")
...
```java
HttpResponse<String> response = Unirest.post("https://api.nz.sandbox.zepto.money/open_agreements")
  .header("content-type", "application/json")
  .header("accept", "application/json")
  .header("authorization", "Bearer {access-token}")
...
$request->setRequestUrl('https://api.nz.sandbox.zepto.money/open_agreements');
$request->setRequestMethod('POST');
$request->setBody($body);
...
```java
HttpResponse<String> response = Unirest.get("https://api.nz.sandbox.zepto.money/open_agreements")
  .header("accept", "application/json")
  .header("authorization", "Bearer {access-token}")
  .asString();
```
...
```shell
curl --request POST \
  --url https://api.nz.sandbox.zepto.money/open_agreements/OA.1/activate \
  --header 'accept: application/json' \
  --header 'authorization: Bearer {access-token}'
```
...
url = URI("https://api.nz.sandbox.zepto.money/open_agreements/OA.1/activate")
...
```java
HttpResponse<String> response = Unirest.post("https://api.nz.sandbox.zepto.money/open_agreements/OA.1/activate")
  .header("accept", "application/json")
  .header("authorization", "Bearer {access-token}")
  .asString();
```
...
$request->setRequestUrl('https://api.nz.sandbox.zepto.money/open_agreements/OA.1/activate');
$request->setRequestMethod('POST');
$request->setHeaders(array(
  'authorization' => 'Bearer {access-token}',
  'accept' => 'application/json'
...
```shell
curl --request POST \
  --url https://api.nz.sandbox.zepto.money/open_agreements/OA.1/close \
  --header 'accept: application/json' \
  --header 'authorization: Bearer {access-token}'
```
...
url = URI("https://api.nz.sandbox.zepto.money/open_agreements/OA.1/close")
...
```java
HttpResponse<String> response = Unirest.post("https://api.nz.sandbox.zepto.money/open_agreements/OA.1/close")
  .header("accept", "application/json")
  .header("authorization", "Bearer {access-token}")
  .asString();
```
...
$request->setRequestUrl('https://api.nz.sandbox.zepto.money/open_agreements/OA.1/close');
$request->setRequestMethod('POST');
$request->setHeaders(array(
  'authorization' => 'Bearer {access-token}',
  'accept' => 'application/json'
